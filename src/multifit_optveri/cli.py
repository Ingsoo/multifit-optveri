...
def _build_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--machine", type=int, help="Restrict to a single machine count.")
    run_parser.add_argument("--job", type=int, help="Restrict to a single job count.")
    run_parser.add_argument(
        "--acceleration-case",
        choices=[case.value for case in AccelerationCase],
        help="Restrict to a single acceleration case.",
    )
    run_parser.add_argument("--limit", type=int, help="Run only the first N matching cases.")
    return parser
